...
<div id="wst-shortcut">
	<div class="w">
		<ul class="fr lh" style='float:right;'>
			<li class="fore1" id="loginbar"><a href="<?php echo U('Home/Orders/queryByPage');?>"><span style='color:blue'><?php echo ($WST_USER['userName']?$WST_USER['userName']:$WST_USER['loginName']); ?></span></a> 嗨，欢迎来<a href="">买手会商城</a>！<s></s>&nbsp;
			<span>
	...
	<div class="wst-ad" >
		<div class="wst-slide" id="wst-slide">
			<ul class="wst-slide-items">
				<?php $_result=WSTAds(-1);if(is_array($_result)): $k = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li style="z-index: 1;"><a target="_blank" onclick="addAccess(<?php echo ($vo['adId']); ?>)" href="<?php echo ($vo['adURL']); ?>">
		...
		<?php if(is_array($catList)): $k1 = 0; $__LIST__ = $catList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($k1 % 2 );++$k1;?><div class="wst-floor">
			<div class="wst-fl-left wst-fl<?php echo ($k1); ?>" style="position: relative;">
				...
				<div class="wst-fl-head"
					style="background: url(/Apps/Home/View/default/images/<?php echo ($k1); ?>fhd.png) no-repeat 100% 100%;">
					<a
			...
			<div class="wst-fl-right">
				<div class="wst-fl-nvg<?php echo ($k1); ?>">
					<ul>
						<li id="fl_<?php echo ($k1); ?>_0" class="wst-fl-tab"
							onmouseover="gpanelOver(this);">精品推荐</li>
						<?php if(is_array($vo1['catChildren'])): $k2 = 0; $__LIST__ = $vo1['catChildren'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($k2 % 2 );++$k2;?><li id="fl_<?php echo ($k1); ?>_<?php echo ($k2); ?>" class="wst-fl-tab"
						...
						<?php if(is_array($vo2['goods'])): $k3 = 0; $__LIST__ = $vo2['goods'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($k3 % 2 );++$k3;?><li class="wst-goodsbox">
							...
							<div class="wst-goods-thumb-des">
								...
								<div>
									...
									<a href="javascript:addCart(<?php echo ($vo3['goodsId']); ?>,0,'<?php echo ($vo3['goodsThums']); ?>')" class="wst-right <?php if(session('WST_USER.userId') > 0 ): ?>btnCart<?php endif; ?>" > <img
